...
export const metadata = {
  metadataBase: new URL('https://weebhub-nexus-anime.vercel.app'),
  applicationName: "WeebHub Nexus",
  title: "WeebHub Nexus : Stream Anime Free Without Those Annoying Ads",
  icons: {
    icon: '/images/logo.png',
  },
  description: "Welcome to WeebHub Nexus, your ultimate destination for streaming anime free of charge and without any annoying ads. Dive into a vast collection of your favorite anime series and movies, all available in high quality. Enjoy a seamless viewing experience with zero interruptions, and explore new titles every day. At WeebHub Nexus, your anime adventure awaits!",
  keywords: [
    'anime',
    'anilist-tracker',
    'trending anime',
    ...
    'weebhub-nexus',
    'weebhub-nexus anime',
    'weebhub-nexus anime watch online',
    'weebhub-nexus-anime website',
    'weebhub-nexus-anime',
    'weebhub-nexus vercel',
    'weebhub-nexus vercel.dev',
    'anime release schedule',
    'watch anime legally',
    'anime marathons',
    'anime streaming without signup',
    'weebhub-nexus anime library',
    'weebhub-nexus anime catalog',
    'latest anime trends',
    'anime simulcast',
    'anime with multiple audio tracks',
    'weebhub-nexus dubbed anime',
    'anime in multiple languages',
    'anime with subtitles',
    'anime episode tracker',
    'weebhub-nexus anime subscriptions',
    'free anime episodes',
    'latest anime on weebhub-nexus',
    'anime streaming high quality',
    'discover new anime',
    'anime streaming without ads',
    'weebhub-nexus anime news',
    'anime streaming schedule',
    'weebhub-nexus anime events',
    'follow anime on weebhub-nexus',
    'watch anime in 4K',
    'anime HD streaming',
    'weebhub-nexus anime blog',
    'anime streaming experience',
    'anime series marathon',
    'popular anime on weebhub-nexus',
    'anime episode countdown',
    'anime streaming updates',
    'anime on demand',
    'weebhub-nexus anime guide',
    'anime streaming service weebhub-nexus',
    'anime streaming interface',
    'watch anime weebhub-nexus website'
  ],
  appleWebApp: {
    capable: true,
